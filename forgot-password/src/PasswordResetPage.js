...
import img from './doctor-image123.jpg';
        ...
        <div className="card border-light-subtle shadow-sm">
          <div className="row g-0">
            <div className="col-12 col-md-6">
              <img className="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" src={img} alt="BootstrapBrain Logo" />
            </div>
            <div className="col-12 col-md-6">
                  ...
                  <div className="row gy-3 gy-md-4 overflow-hidden">
                    ...
                    <div className="col-12">
                      <div className="d-grid">
                        <button className="btn bsb-btn-xl btn-primary" type="submit" style={{backgroundColor : 'rgb(38,122,107)'}}>Reset Password</button>
                      </div>
                    </div>
                  </div>
                </form>
